...
@Import({RedisConfig.class, WebTestConfig.class, WaitQueueRedisRepositoryImpl.class})
@DataJpaTest
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE)
class WaitQueueRedisRepositoryImplTest {

    private final WaitQueueRedisRepositoryImpl waitQueueRedisRepository;
    private final RedisTemplate<String, String> redisTemplate;

    public WaitQueueRedisRepositoryImplTest(
            @Autowired WaitQueueRedisRepositoryImpl waitQueueRedisRepository,
